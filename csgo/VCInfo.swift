...
class VCInfo: UIViewController, GADInterstitialDelegate {
    ...
    @IBAction func feedbackButton(_ sender: Any) {
        if let url = URL(string: "itms-apps://itunes.apple.com/ru/app/id1382287105"){
            UIApplication.shared.open(url, options: [:])
        }
    }
    
    @IBAction func shareButton(_ sender: Any) {
        let activityVC = UIActivityViewController(activityItems: ["Зацени крутое приложение https://itunes.apple.com/ru/app/id1382287105"], applicationActivities: nil)
